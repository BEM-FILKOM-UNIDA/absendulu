...
-- Run this migration in Supabase SQL Editor before adding another user.
-- It keeps profiles.full_name and profiles.nim non-null when no metadata is provided.
...
-- Ensure the trigger points to the repaired function.
