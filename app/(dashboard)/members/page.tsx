...
export default async function MembersPage() {
  ...
  return (
    <div className="space-y-8">
      <section className="border-b border-[var(--border)] pb-8"><p className="eyebrow text-[var(--accent-strong)]">data mahasiswa / admin FILKOM</p><h1 className="display-type mt-3 text-4xl leading-none tracking-[-.07em] sm:text-5xl">Siapa saja<br /><em>yang terdaftar.</em></h1><p className="mt-4 max-w-md text-sm leading-6 text-[var(--muted)]">Kelola daftar mahasiswa, dosen, dan tenaga kependidikan yang dapat mengikuti absensi acara FILKOM.</p></section>
      <MemberImportForm />
