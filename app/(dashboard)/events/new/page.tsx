...
export default function NewEventPage() {
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <section className="border-b border-[var(--border)] pb-8"><p className="eyebrow text-[var(--accent-strong)]">buat kegiatan / panitia FILKOM</p><h1 className="display-type mt-3 text-5xl leading-none tracking-[-.07em]">Siapkan<br /><em>acara baru.</em></h1><p className="mt-4 max-w-md text-sm leading-6 text-[var(--muted)]">Isi detail kegiatan organisasi. Setelah acara dibuat, panitia bisa membuka QR absensi.</p></section>
