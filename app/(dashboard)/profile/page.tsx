...
export default async function ProfilePage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <section className="border-b border-[var(--border)] pb-8"><p className="eyebrow text-[var(--accent-strong)]">identitas mahasiswa / FILKOM</p><h1 className="display-type mt-3 text-4xl leading-none tracking-[-.07em] sm:text-5xl">Profil<br /><em>Absendulu.</em></h1></section>
